...
public class Che2 : MonoBehaviour
{
    ...
    void OnClick()
    {
        ...
        {
            TechManage.Che2 = true;
            TechManage.TechPoints -= 50;
            m = "Your Chemistry degree is promoted to master, your acid turrets can made the enemies even slower by 50%";
            ChangeTech();
