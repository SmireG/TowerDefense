...
public class CSButton : MonoBehaviour
{
   ...
   // public Text techText;
     ...
     void  OnClick()
    {
        ...
        string a = "Your CS degree is promoted to bachelor, all your turrets' attack rate is promoted.";
        ...
        else
        {
            ...
            ChangeTech("Your CS degree is promoted to bachelor, all your turrets' attack rate is promoted.");
