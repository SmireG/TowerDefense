...
public class Che3 : MonoBehaviour
{
    ...
    void OnClick()
    {
        ...
        {
            TechManage.Che3 = true;
            TechManage.TechPoints -= 50;
            m = "Your Chemistry degree is promoted to P.h.d, your acid turrets can made the enemies even slower by 50%";
            ChangeTech();
